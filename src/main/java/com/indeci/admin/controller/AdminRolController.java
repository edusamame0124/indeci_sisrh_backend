...
public class AdminRolController {
    ...
    public ApiResponse<List<AdminPermisoResponse>> permisos(@PathVariable Long id) {
        return new ApiResponse<>("OK", "Permisos del rol", metadataService.listPermisosDeRol(id));
    }
}
