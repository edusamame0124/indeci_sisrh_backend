...
public class PersonaService {
    ...
    public PersonaEmpleadoResponseDto obtenerMiPerfil() {
        ...
        Empleado empleado = resolverEmpleadoPropio();
    ...
    @Transactional
    public PersonaEmpleadoResponseDto actualizarMiPerfil(MiPerfilUpdateDto dto) {
        ...
        persona.setTelefono(dto.getTelefono());
        persona.setEmail(dto.getCorreoPersonal());
        persona.setDireccion(dto.getDireccion());
        persona.setContactoEmergenciaNombre(dto.getContactoEmergenciaNombre());
        persona.setContactoEmergenciaParentesco(dto.getContactoEmergenciaParentesco());
        persona.setContactoEmergenciaTelefono(dto.getContactoEmergenciaTelefono());
    ...
    private Empleado resolverEmpleadoPropio() {
